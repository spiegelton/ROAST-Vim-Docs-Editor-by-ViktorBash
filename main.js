...
function setKeyMap(vimVariant) {
	...
	vimVariant.keyMapV = keyMapV;
	vimVariant.keyMapVLine = keyMapVLine;
}
...
function runVim() {
	...
	// Set the bindings (what keys correspond to what commands)
	setKeyMap(vimVariant);
