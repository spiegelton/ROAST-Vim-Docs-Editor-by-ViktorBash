...
export function getDefaultKeyBindings() {
	...
	let keyMapV = {
		...
		s: ["s", false, 0b0000, "Delete highlighted text and enter insert mode", false],
		...
		S: ["S", false, 0b0100, "Delete all lines of the highlighted text and enter insert mode", null],
	...
	let keyMapVLine = {
		...
		S: ["S", false, 0b0100, "Delete highlighted text and enter insert mode", false],
