...
export function getDefaultKeyBindings() {
	let keyMapN = {
		...
		gg: ["g" + KEY_SEPARATOR + "g", true, 0b0000, "Go to the start of the document"],
		G: ["G", false, 0b0100, "Go to the end of the document"],
		...
		escape: ["Escape", true, 0b0000, "Clear any command in progress"],
		ctrlC: ["c", false, 0b1000, "Clear any command in progress"],
		slashSearch: ["/", false, 0b0000, "Search for text"],
		ctrlDPageDown: ["d", false, 0b1000, "Move cursor down several lines"],
		ctrlUPageUp: ["u", false, 0b1000, "Move cursor up several lines"],
		...
		newLineAbove: ["O", false, 0b0100, "Add an empty line above the cursor and enter insert mode on it"],
		newLineBelow: ["o", false, 0b0000, "Add an empty line below the cursor and enter insert mode on it"],
		...
		deleteInnerWord: ["d" + KEY_SEPARATOR + "i" + KEY_SEPARATOR + "w", true, 0b0000, "Delete word (not whitespace)"],
		deleteInnerWordInsert: ["c" + KEY_SEPARATOR + "i" + KEY_SEPARATOR + "w", true, 0b0000, "Delete word (not whitespace) and enter insert mode"],
		...
		"0": ["0", false, 0b000, "Go to start of the line"],
	}
	...
	let keyMapI = {
		...
		escape: ["Escape", true, 0b0000, "Exit to normal mode"],
		ctrlC: ["c", false, 0b1000, "Exit to normal mode"],
	}

	let keyMapV = {
		arrowLeft: ["ArrowLeft", false, 0b0000, "Highlight left"],
		arrowRight: ["ArrowRight", false, 0b0000, "Highlight right"],
		arrowUp: ["ArrowUp", false, 0b0000, "Highlight up"],
		arrowDown: ["ArrowDown", false, 0b0000, "Highlight cursor down"],
		backspace: ["Backspace", false, 0b0000, "Highlight cursor left"],
		b: ["b", false, 0b0000, "Highlight backwards to the start of a word"],
		B: ["B", false, 0b0100, "Highlight backwards to the start of a word"],
		h: ["h", false, 0b0000, "Highlight left"],
		j: ["j", false, 0b0000, "Highlight down"],
		k: ["k", false, 0b0000, "Highlight up"],
		l: ["l", false, 0b0000, "Highlight right"],
		gg: ["g" + KEY_SEPARATOR + "g", true, 0b0000, "Highlight to top of document"],
		G: ["G", false, 0b0100, "Highlight to bottom of document"],
		"{": ["{", false, 0b0100, "Highlight to previous paragraph"],
		"}": ["}", false, 0b0100, "Highlight to next paragraph"],
		e: ["e", false, 0b0000, "Highlight to end of word"],
		E: ["E", false, 0b0100, "Highlight to end of word"],
		escape: ["Escape", true, 0b0000, "Exit to normal mode"],
		ctrlC: ["c", false, 0b1000, "Exit to normal mode"],
		u: ["u", false, 0b0000, "Exit to normal to undo"],
		U: ["U", false, 0b0100, "Exit to normal to undo"],
		redo: ["r", false, 0b1000, "Exit to normal to redo"],
		slashSearch: ["/", false, 0b0000, "Search for text"],
		paste: ["p", false, 0b0000, "Paste after cursor"], // TODO: Change into 2 functions on the other side
		pasteNoFormatting: ["p", false, 0b1000, "Paste after cursor with no formatting"],
		pasteBeforeCursor: ["P", false, 0b0100, "Paste before cursor"],
		...
		d: ["d", false, 0b0000, "Delete highlighted text"],
		c: ["c", false, 0b0000, "Delete highlighted text and enter insert mode"],
		D: ["D", false, 0b0100, "Delete all lines of the highlighted text"],
		C: ["C", false, 0b0100, "Delete all lines of the highlighted text and enter insert mode"],
		y: ["y", false, 0b0000, "Yank/copy the highlighted text"],
		arrowLeftCtrl: ["ArrowLeft", false, 0b1000, "Highlight left with Ctrl (Cmd on Mac)"],
		arrowRightCtrl: ["ArrowRight", false, 0b1000, "Highlight right with Ctrl (Cmd on Mac)"],
		arrowDownCtrl: ["ArrowDown", false, 0b1000, "Highlight down with Ctrl (Cmd on Mac)"],
		arrowUpCtrl: ["ArrowUp", false, 0b1000, "Highlight up with Ctrl (Cmd on Mac)"],
		ctrlDPageDown: ["d", false, 0b1000, "Highlight down several lines"],
		ctrlUPageUp: ["u", false, 0b1000, "Highlight up several lines"],
		w: ["w", false, 0b0000, "Highlight forwards to the start of a word"],
		W: ["W", false, 0b0100, "Highlight forwards to the start of a word"],
		"0": ["0", false, 0b000, "Highlight to start of the line"],
	}

	let keyMapVLine = {
		arrowUp: ["ArrowUp", false, 0b0000, "Highlight up"],
		arrowDown: ["ArrowDown", false, 0b0000, "Highlight down"],
		j: ["j", false, 0b0000, "Highlight down"],
		k: ["k", false, 0b0000, "Highlight up"],
		gg: ["g" + KEY_SEPARATOR + "g", true, 0b0000, "Highlight to top of document"],
		G: ["G", false, 0b0100, "Highlight to bottom of document"],
		...
		slashSearch: ["/", false, 0b0000, "Search for text"],
		paste: ["p", false, 0b0000, "Paste after cursor"], // TODO: Change into 2 functions on the other side
		pasteNoFormatting: ["p", false, 0b1000, "Paste after cursor no formatting"],
		pasteBeforeCursor: ["P", false, 0b0100, "Paste before cursor"],
		pasteBeforeCursorNoFormatting: ["P", false, 0b1100, "Paste before cursor no formatting"],
		insertStartOfHighlight: ["I", false, 0b0100, "Insert at start of highlight"],
		exitToVisualMode: ["v", false, 0b0000, "Exit to visual mode"],
		exitVisualLineMode: ["V", false, 0b0100, "Exit to normal mode"],
		appendEndOfHighlight: ["A", false, 0b0100, "Append at end of highlight"],
		x: ["x", false, 0b0000, "Delete highlighted text"],
		d: ["d", false, 0b0000, "Delete highlighted text"],
		c: ["c", false, 0b0000, "Delete highlighted text and enter insert mode"],
		D: ["D", false, 0b0100, "Delete highlighted text"],
		C: ["C", false, 0b0100, "Delete highlighted text and enter insert mode"],
		y: ["y", false, 0b0000, "Copy highlighted text"],
		arrowDownCtrl: ["ArrowDown", false, 0b1000, "Highlight down"],
		arrowUpCtrl: ["ArrowUp", false, 0b1000, "Highlight up"],
		ctrlDPageDown: ["d", false, 0b1000, "Highlight down several lines"],
		ctrlUPageUp: ["u", false, 0b1000, "Highlight up several lines"],
	}
