...
export function getDefaultKeyBindings() {
	let keyMapN = {
		...
		arrowLeftCtrl: ["ArrowLeft", false, 0b1000, "Move cursor left with Ctrl (Cmd on Mac)", null],
		arrowRightCtrl: ["ArrowRight", false, 0b1000, "Move cursor right with Ctrl (Cmd on Mac)", null],
		arrowDownCtrl: ["ArrowDown", false, 0b1000, "Move cursor down with Ctrl (Cmd on Mac)", null],
		arrowUpCtrl: ["ArrowUp", false, 0b1000, "Move cursor up with Ctrl (Cmd on Mac)", null],
		...
		dw: ["d" + KEY_SEPARATOR + "w", true, 0b0000, "Delete to end of word", false],
		dW: ["d" + KEY_SEPARATOR + "W", true, 0b0000, "Delete to end of word", false],
		cw: ["c" + KEY_SEPARATOR + "w", true, 0b0000, "Delete to end of word and enter insert mode", false],
		cW: ["c" + KEY_SEPARATOR + "W", true, 0b0000, "Delete to end of word and enter insert mode", false],
		...
		deleteInnerWord: ["d" + KEY_SEPARATOR + "i" + KEY_SEPARATOR + "w", true, 0b0000, "Delete word (not whitespace)", false],
		deleteInnerWordInsert: ["c" + KEY_SEPARATOR + "i" + KEY_SEPARATOR + "w", true, 0b0000, "Delete word (not whitespace) and enter insert mode", false],
		deleteWord: ["d" + KEY_SEPARATOR + "a" + KEY_SEPARATOR + "w", true, 0b0000, "Delete word (including whitespace)", false],
		deleteWordInsert: ["c" + KEY_SEPARATOR + "a" + KEY_SEPARATOR + "w", true, 0b0000, "Delete word (including whitespace) and enter insert mode", false],
	...
	let keyMapV = {
		...
		slashSearch: ["/", false, 0b0000, "Search for text", null],
		paste: ["p", false, 0b0000, "Paste after cursor", false], // TODO: Change into 2 functions on the other side
		pasteNoFormatting: ["p", false, 0b1000, "Paste after cursor with no formatting", false],
		pasteBeforeCursor: ["P", false, 0b0100, "Paste before cursor", false],
		pasteBeforeCursorNoFormatting: ["P", false, 0b1100, "Paste before cursor with no formatting", false],
		...
		D: ["D", false, 0b0100, "Delete all lines of the highlighted text", false],
		C: ["C", false, 0b0100, "Delete all lines of the highlighted text and enter insert mode", false],
		y: ["y", false, 0b0000, "Yank/copy the highlighted text", null],
		arrowLeftCtrl: ["ArrowLeft", false, 0b1000, "Highlight left with Ctrl (Cmd on Mac)", null],
		arrowRightCtrl: ["ArrowRight", false, 0b1000, "Highlight right with Ctrl (Cmd on Mac)", null],
		arrowDownCtrl: ["ArrowDown", false, 0b1000, "Highlight down with Ctrl (Cmd on Mac)", null],
		arrowUpCtrl: ["ArrowUp", false, 0b1000, "Highlight up with Ctrl (Cmd on Mac)", null],
	...
	let keyMapVLine = {
		...
		slashSearch: ["/", false, 0b0000, "Search for text", null],
		paste: ["p", false, 0b0000, "Paste after cursor", false], // TODO: Change into 2 functions on the other side
		pasteNoFormatting: ["p", false, 0b1000, "Paste after cursor no formatting", false],
		pasteBeforeCursor: ["P", false, 0b0100, "Paste before cursor", false],
		pasteBeforeCursorNoFormatting: ["P", false, 0b1100, "Paste before cursor no formatting", false],
		insertStartOfHighlight: ["I", false, 0b0100, "Insert at start of highlight", null],
