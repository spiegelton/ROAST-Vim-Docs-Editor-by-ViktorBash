...
windowsVim.switchToVisualLineMode = function () {
	...
	windowsVim.num = "";
    windowsVim.visualLineModeDown = true;
	UI.updateUISequenceText("");
...
windowsVim.normal_keydown = function (e) {
    ...
    switch (true) {
        ...
        case (keyMapN.zb[0] === windowsVim.currentSequence && (keyMapN.zb[1] === true || keyMapN.zb[2] === modifierInput)):
        {
            docs.scrollSoCursorIsBottom();
            this.clearData();
            return true;
        }
        // case (keyMapN.ctrlE[0] === windowsVim.currentSequence && (keyMapN.ctrlE[1] === true || keyMapN.ctrlE[2] === modifierInput)):
        // {
        //     docs.scrollDownWithCursor();
        //     this.clearData();
        //     return true;
        // }
        ...
        case (keyMapN.s[0] === windowsVim.currentSequence && (keyMapN.s[1] === true || keyMapN.s[2] === modifierInput)):
        {
            ...
            if (rightCounter > 0) {
                ...
                if (startXCoord === newXCoord && startYCoord === newYCoord) {
                    ...
                    // Still on an empty line, so just go back
                    docs.pressKey(docs.codeFromKey("ArrowRight"));
                }
                else {
                    if (shouldWeCut) {
...
windowsVim.visual_keydown = function (e) {
    ...
    switch (true) {
        ...
        case (keyMapV.s[0] === windowsVim.currentSequence && (keyMapV.s[1] === true || keyMapV.s[2] === modifierInput)):
            {
                let shouldWeCut = keyMapV.s[4];
                this.deleteOrCut(shouldWeCut);
                windowsVim.clearData();
                windowsVim.switchToInsertMode();
                return true;
...
windowsVim.switchVisualLineDirection = function () {
...
windowsVim.visual_line_keydown = function (e) {
    ...
    switch (true) {
        ...
        case (keyMapVLine.exitToVisualMode[0] === windowsVim.currentSequence && (keyMapVLine.exitToVisualMode[1] === true || keyMapVLine.exitToVisualMode[2] === modifierInput)):
        {
            ...
            if (keyMapVLine.exitToVisualMode[0] === windowsVim.currentSequence && (keyMapVLine.exitToVisualMode[1] === true || keyMapVLine.exitToVisualMode[2] === modifierInput)) {
                this.clearData();
                this.switchToVisualMode();
                return true;
            }
